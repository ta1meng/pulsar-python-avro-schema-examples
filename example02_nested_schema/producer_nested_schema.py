...
from example02_nested_schema.NestedSchema import Example, MySubRecord
...
producer = client.create_producer(topic='persistent://climate/sandbox/nested-schema', schema=topicSchema)
